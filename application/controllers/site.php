...
class Site extends CI_Controller {
	...
	public function index($ref)
	{
		...
		/* Halaman */
			...
			$this->data['sidebar'] = $this->setting->getHalaman('produk');
			$this->data['peluang'] = $this->setting->getPagesByPermalink('produk-james-b-dinar')->isi;
			$this->data['mengapakami'] = $this->setting->getPagesByPermalink('produk-top-tan')->isi;
			$this->data['presentasibisnis'] = $this->setting->getPagesByPermalink('produk-bio-nain')->isi;
			$this->data['carakerja'] = $this->setting->getPagesByPermalink('asuransi-nyaman')->isi;
