...
<head>
	...
	<title>.: BMI Tiger - Member of PT. Berkat Merdeka Indonesia :.</title>
		...
		<div class="tengah">
				...
				<div class="konten">
					...
					<center>
						...
						Web Bisnis : <a href="http://bmi-eksekutif.com/site/<?php echo $username;?>">www.bmi-eksekutif.com/site/<?php echo $username;?></a><br>
						Toko Online : <a href="http://produkbmi.com/site/<?php echo $username;?>">www.produkbmi.com/site/<?php echo $username;?></a><br>
					</center>
				</div>
		</div>
		<div class="footer">
